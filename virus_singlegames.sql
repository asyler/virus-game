...
--
-- Table structure for table `singlegames`
--

DROP TABLE IF EXISTS `singlegames`;
...
CREATE TABLE `singlegames` (
  ...
  UNIQUE KEY `Unique_cell` (`GameID`,`X`,`Y`,`State`),
...
--
-- Dumping data for table `singlegames`
--

LOCK TABLES `singlegames` WRITE;
/*!40000 ALTER TABLE `singlegames` DISABLE KEYS */;
/*!40000 ALTER TABLE `singlegames` ENABLE KEYS */;
UNLOCK TABLES;
